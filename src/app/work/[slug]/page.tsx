...
export default function ProjectPage() {
  ...
  const isYoutube = project.slug === "som-la-resistencia";
          ...
          <div className="overflow-hidden rounded-2xl">
            {isYoutube ? (
              <div className="aspect-video w-full">
                <iframe
                  src="https://www.youtube.com/embed/Yzk7oRw-2CE?rel=0"
                  title={project.title}
